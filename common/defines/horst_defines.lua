...
NDefines.NMilitary.UNIT_LEADER_TRAIT_SLOT_PER_LEVEL = { 0.75, 0.75, 0.75, 0}
...
NDefines.NAir.AIR_WING_XP_TRAINING_MISSION_ACCIDENT_FACTOR = 0     -- Changed so people don't feel bad for overtraining and can set up air training and go AFK/ignore the planes without being punished for it -Thrasymachus
...
NDefines.NCountry.ARMY_SCORE_MULTIPLIER = 0.75					-- Based on number of armies.
NDefines.NCountry.NAVY_SCORE_MULTIPLIER = 1					-- Based on number of navies.
NDefines.NCountry.AIR_SCORE_MULTIPLIER = 0.25					-- Based on number of planes (which is typically a lot).
NDefines.NCountry.INDUSTRY_SCORE_MULTIPLIER = 1				-- Based on number of factories.
NDefines.NCountry.PROVINCE_SCORE_MULTIPLIER = 1				-- Based on number of controlled provinces.
